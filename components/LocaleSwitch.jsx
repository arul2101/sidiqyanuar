  ...
  return (
    <>
      <div className="relative inline-block text-left">
        ...
        {isOpen && (
          <m.div
            className="origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white dark:bg-slate-500 dark:text-white ring-1 ring-black ring-opacity-5 z-50 transition-all animate-show-fade-in"
            // initial={{ opacity: 0 }}
            // animate={{ opacity: 1 }}
            // exit={{ opacity: 0 }}
