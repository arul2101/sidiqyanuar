      ...
      >
        <div>
          ...
          <div className="mt-4 flex gap-2 items-center">
            <a href={demo} target="_blank" className="bg-blue-600 dark:bg-dark-mode2nd text-white flex items-center gap-2 px-2 py-2 border-2 border-blue-600 dark:border-[#76ABAE] hover:shadow-lg duration-300 hover:scale-105 w-[8rem] rounded-md">
              <SquareArrowOutUpRight className="h-4 w-4" />
              Live demo
            </a>
            {github && (
              <a href={github} target="_blank" className="  flex items-center gap-2 px-2 py-2 border-[1px] border-black dark:bg-white dark:text-black hover:shadow-lg duration-300 hover:scale-105 w-[8rem] rounded-md">
          ...
          <div className="mt-8">
            ...
            <div className="flex gap-2 flex-wrap">
              {techstack?.length > 0 && techstack.map(tech => (
                <TechStack key={tech} icon={icons[tech.toLowerCase().split(" ")[0]]} title={tech} />
              ))}
            </div>
          </div>
        </div>
